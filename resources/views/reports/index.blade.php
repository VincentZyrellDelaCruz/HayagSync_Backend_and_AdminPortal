...
@section('title', 'Report Management - HayagSync')
                    ...
                    <div class="p-5 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="space-y-1">
                                ...
                                <a href="{{ route('web.reports.index', $allCategoryQuery) }}"
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                    ...
                    <div class="divide-y divide-slate-200">
                        @forelse($reports as $report)
                            @php
                                $status = $report->current_status?->status_name ?? 'No Status';
                            ...
                            <a href="{{ route('web.reports.show', $report->id) }}"
                        ...
                        @empty
                            <div class="px-6 py-16 text-center">
                                ...
                                <h3 class="text-lg font-semibold text-slate-700">No reports found</h3>
